Here is a professional, research-grade `README.md` for your GitHub repository. It reflects the final architectural decision to use the **"Lobotomized" `fx2-cmix**` as the oracle, while maintaining the rigorous mathematical improvements (Hellinger distance, Entropy-Derivative segmentation) discussed in the final paper draft.

I have structured it to serve both as code documentation and a project landing page.
